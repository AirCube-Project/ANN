...
class SensorDataLoader(DataLoader):
    ...
    def plot_variable_distributions(self, data, which_data):
        ...
        sensor_data_dist_path = os.path.join(main_app_path, self.config.config_namespace.graph_dir,
                                             "{}_sensor_{}_values_distributions.png".format(dist_file_name, which_data))
    ...
    def display_data_element(self, which_data, index):
        ...
        if which_data == "train_data":
            ...
            # Save the plot to disk.
            sensor_data_ts_path = os.path.join(main_app_path, self.config.config_namespace.graph_dir,
                                               "sensor_ts_index_{}_{}.png".format(index, which_data))
